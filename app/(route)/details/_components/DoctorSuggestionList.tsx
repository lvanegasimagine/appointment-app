  ...
  return (
        <div className=' p-4 border-[1px] mt-5 md:ml-5 rounded-lg w-full'>
            ...
            {doctorList.map((doctor: any, index) => (
                <Link href={'/details/' + doctor.id} key={index} className=' mb-4 p-3 shadow-sm w-full cursor-pointer hover:bg-slate-100 rounded-lg md:flex md:flex-col lg:flex lg:flex-row items-center gap-3'>
